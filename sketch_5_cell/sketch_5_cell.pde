...
void setup(){
  size(1000, 1000, P3D);
  //fullScreen(P3D);
  points[0] = new P4Vector(1./sqrt(10), 1./sqrt(6), 1./sqrt(3), 1);
  points[1] = new P4Vector(1./sqrt(10), 1./sqrt(6), 1./sqrt(3), -1);
  points[2] = new P4Vector(1./sqrt(10), 1./sqrt(6), -2./sqrt(3), 0);
  points[3] = new P4Vector(1./sqrt(10), -sqrt(3./2), 0, 0);
  points[4] = new P4Vector(-2.*sqrt(2./5), 0, 0, 0);
...
void draw(){
  ...
  for (int i=0; i<4; i++){//connect vertex each other
    for(int j=i; j<=4; j++){
